    ...
    <div class="container px-5 my-5">
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="lead fw-normal text-muted mb-0" style="text-align: justify; text-justify: distribute;">Desde nuestros inicios, hemos estado comprometidos a brindar un servicio excepcional a quienes enfrentan la difícil situación de un accidente. Nuestra experiencia y dedicación nos han permitido ayudar a miles de personas a navegar por el proceso legal y emocional.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container px-5 my-5">
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="lead fw-normal text-muted mb-0" style="text-align: justify; text-justify: distribute;">A medida que hemos crecido, también lo ha hecho nuestro compromiso con la excelencia. Nos esforzamos por mejorar continuamente nuestros servicios y adaptarnos a las necesidades de nuestros clientes, asegurando que siempre reciban el mejor apoyo posible.</p>
            </div>
        </div>
    </div>
</section>
